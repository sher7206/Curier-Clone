...
//    func uploadRegion() {
//        let getRegion = GetRegionService()
...
//        if isStore{
//            cell.updateCell(textlbl: getAllDates?[indexPath.row].name ?? "")
//        }else{
...
//                self.branchDelegate?.branchId(
//                    branch: self.getAllDates?[indexPath.row].id ?? 0,
//                    branch: self.getAllDates?[indexPath.row].name ?? "")
//
//                self.branchDelegate?.setLocatoinRegion(region: self.getAllDates?[indexPath.row].region_id ?? 0,
//                                                       regoin: self.getAllDates?[indexPath.row].region?.name ?? "",
//                                                       stateId: self.getAllDates?[indexPath.row].district_id ?? 0,
//                                                       stateName: self.getAllDates?[indexPath.row].district?.name ?? "")
//            }
//        }else{
//            switch pageType {
//            case .region:
...
//        if isStore {
//            guard let datas = getAllDates else {return}
//            if indexPath.row == datas.count - 1{
//                if self.totalItems > datas.count{
//                    self.currentPage += 1
//                    Loader.start()
//                    self.getStore(page: self.currentPage)
//                }
//            }
//        }
//    }
